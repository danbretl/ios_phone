...
- (EventsWebQuery *) getMostRecentEventsRecommendedWebQuery {
    return [self getMostRecentEventsWebQueryWithPredicate:[NSPredicate predicateWithFormat:@" queryType == %@", [NSNumber numberWithInt:RecommendedQuery]]];
}

- (EventsWebQuery *) getMostRecentEventsSearchWebQuery {
    return [self getMostRecentEventsWebQueryWithPredicate:[NSPredicate predicateWithFormat:@"queryType == %@", [NSNumber numberWithInt:SearchQuery]]];
}
